...
\begin{figure}[h!]
    \begin{subfigure}{0.5\textwidth}
        \includegraphics[scale=0.5]{../../images/comparison/validation/DCF_LRQ&GMM.png}
    \end{subfigure}
    \begin{subfigure}{0.5\textwidth}
        \includegraphics[scale=0.5]{../../images/comparison/validation/ROC_LRQ&GMM.png}
    \end{subfigure}
    \label{fig:MVGvsGMM}
\end{figure}
...
\begin{figure}[h!]
    \begin{subfigure}{0.5\textwidth}
        \includegraphics[scale=0.5]{../../images/comparison/validation/DCF_LRQ&SVM_RBF.png}
    \end{subfigure}
    \begin{subfigure}{0.5\textwidth}
        \includegraphics[scale=0.5]{../../images/comparison/validation/ROC_LRQ&SVM_RBF.png}
    \end{subfigure}
    \label{fig:MVGvsSVM}
\end{figure}
...
\begin{figure}[H]
    \begin{subfigure}{0.5\textwidth}
        \includegraphics[scale=0.5]{../../images/comparison/validation/DCF_LRQ&SVM_RBF_calibrated.png}
    \end{subfigure}
    \begin{subfigure}{0.5\textwidth}
        \includegraphics[scale=0.5]{../../images/comparison/validation/ROC_LRQ&SVM_RBF_calibrated.png}
    \end{subfigure}
...
\begin{figure}[h!]
    \includegraphics[scale = 0.5]{../../images/evaluation/QUAD_LR_PCA_minDCF_comparison.png}
    \centering
    \caption{minDCF for the QLR}
    \label{fig:QLR_eval}
\end{figure}

Figure ~\ref{fir:QLR_eval} show that PCA will perform badly, in fact for all application we have the minDCF related
...
\begin{figure}[H]
    \begin{subfigure}{0.5\textwidth}
        \includegraphics[scale=0.5]{../../images/comparison/evaluation/DCF_LRQ&GMM.png}
    \end{subfigure}
    \begin{subfigure}{0.5\textwidth}
        \includegraphics[scale=0.5]{../../images/comparison/evaluation/ROC_LRQ&GMM.png}
    \end{subfigure}
...
\begin{figure}[H]
    \begin{subfigure}{0.5\textwidth}
        \includegraphics[scale=0.5]{../../images/comparison/evaluation/DCF_LRQ&SVM_RBF.png}
    \end{subfigure}
    \begin{subfigure}{0.5\textwidth}
        \includegraphics[scale=0.5]{../../images/comparison/evaluation/ROC_LRQ&SVM_RBF.png}
    \end{subfigure}
...
\begin{figure}[H]
    \begin{subfigure}{0.5\textwidth}
        \includegraphics[scale=0.5]{../../images/comparison/evaluation/DCF_LRQ&SVM_RBF_calibrated.png}
    \end{subfigure}
    \begin{subfigure}{0.5\textwidth}
        \includegraphics[scale=0.5]{../../images/comparison/evaluation/ROC_LRQ&SVM_RBF_calibrated.png}
    \end{subfigure}
