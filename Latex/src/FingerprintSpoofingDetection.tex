...
\section{Overview}
    ...
    \textit{C\textsubscript{fp}} is 10, so classifing a spoofed fingerprint as an authentic one 
...
As we can see, the MVG model, that consider all the convariance matrices, is the best either with PCA or without. 
...
\begin{table}[H]
    ...
    \begin{tabular}{ll|lllll}
        \hline
                                ...
                                & C = 10.0   & 0.518 & 0.491 & 0.492  \\ \hline
