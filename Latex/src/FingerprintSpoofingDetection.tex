...
space that corresponds to a non-linear separation in the original feature space. For the Quadratic
kernel we have:
...
Figure 2.5 shows the different values of C with K=1, c=1 e d=2.
...
Figure 2.6 shows the different values of C with K=1, c=1 but d=3.
