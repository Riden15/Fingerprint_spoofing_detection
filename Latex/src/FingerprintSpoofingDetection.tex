...
Now let's see the Bayes Error Plot and the ROC curve of each comparison. We start with MVG and GMM.

\begin{figure}[h!]
    \begin{subfigure}{0.5\textwidth}
        \includegraphics[scale=0.5]{../../images/comparison/validation/DCF_MVG&GMM.png}
    \end{subfigure}
    \begin{subfigure}{0.5\textwidth}
        \includegraphics[scale=0.5]{../../images/comparison/validation/ROC_MVG&GMM.png}
    \end{subfigure}
\end{figure}
...
\begin{figure}[h!]
    \begin{subfigure}{0.5\textwidth}
        \includegraphics[scale=0.5]{../../images/comparison/validation/DCF_MVG&SVM_RBF.png}
    \end{subfigure}
    \begin{subfigure}{0.5\textwidth}
        \includegraphics[scale=0.5]{../../images/comparison/validation/ROC_MVG&SVM_RBF.png}
    \end{subfigure}
\end{figure}
Here we clearly need some calibration about the SVM. This is needed beacuse the scores are not calibrated
since SVM has no probabilistic interpretation!
We are going to apply the prior weighted logistic regression as calibration model. Let's define a function
\[f(s) = log\frac{f_{S|H}(s|H_T)}{f_{S|H}(s|H_F)} = \alpha s + \beta\]
where s is the input score, $f(s)$ computes the $s_{cal}$ that is the calibrated score. The original 
score s are the scores obtained by the SVM.

\begin{figure}[H]
    \includegraphics[scale=0.5]{../../images/comparison/validation/DCF_SVM_RBF_calibrated.png}
    \centering
...
\end{figure}
 ...
 Now les't see the SVM RBF Calibrated vs MVG.
\begin{figure}[H]
    \begin{subfigure}{0.5\textwidth}
        \includegraphics[scale=0.5]{../../images/comparison/validation/DCF_MVG&SVM_RBF_calibrated.png}
    \end{subfigure}
    \begin{subfigure}{0.5\textwidth}
        \includegraphics[scale=0.5]{../../images/comparison/validation/ROC_GMM&SVM_RBF_calibrated.png}
    \end{subfigure}
\end{figure}
Again the SVM RBF is slightly better than the MVG, but nothing relevant. Last we have the comparison 
between the SVM RBF and GMM. Again the SVM's scores are not calibrated so let's calibrate them.

\begin{figure}[H]
    \begin{subfigure}{0.5\textwidth}
        \includegraphics[scale=0.5]{../../images/comparison/validation/DCF_GMM&SVM_RBF.png}
    \end{subfigure}
    \begin{subfigure}{0.5\textwidth}
        \includegraphics[scale=0.5]{../../images/comparison/validation/ROC_GMM&SVM_RBF.png}
    \end{subfigure}
\end{figure}
...
\begin{figure}[H]
    \begin{subfigure}{0.5\textwidth}
        \includegraphics[scale=0.5]{../../images/comparison/validation/DCF_GMM&SVM_RBF_calibrated.png}
    \end{subfigure}
    \begin{subfigure}{0.5\textwidth}
        \includegraphics[scale=0.5]{../../images/comparison/validation/ROC_GMM&SVM_RBF_calibrated.png}
    \end{subfigure}
...
\begin{figure}[H]
    \begin{subfigure}{0.5\textwidth}
        \includegraphics[scale=0.5]{../../images/comparison/evaluation/DCF_MVG&GMM.png}
    \end{subfigure}
    \begin{subfigure}{0.5\textwidth}
        \includegraphics[scale=0.5]{../../images/comparison/evaluation/ROC_MVG&GMM.png}
    \end{subfigure}
\end{figure}

The minDCF and actDCF are close, so we don't need any calibration. The GMM model is better than
the MVG for both actDCF and minDCF. Now let's see the SVM vs MVG.

\begin{figure}[H]
    \begin{subfigure}{0.5\textwidth}
        \includegraphics[scale=0.5]{../../images/comparison/evaluation/DCF_MVG&SVM_RBF.png}
    \end{subfigure}
    \begin{subfigure}{0.5\textwidth}
        \includegraphics[scale=0.5]{../../images/comparison/evaluation/ROC_MVG&SVM_RBF.png}
    \end{subfigure}
\end{figure}
Again the SVM RBF is not calibrated, so we need to calibrate the scores. We used the prior weighted
logistic regression.

\begin{figure}[H]
    \includegraphics[scale=0.5]{../../images/comparison/evaluation/DCF_SVM_RBF_calibrated.png}
    \centering
    \caption{SVM RBF Calibrated}
...
\begin{figure}[H]
    \begin{subfigure}{0.5\textwidth}
        \includegraphics[scale=0.5]{../../images/comparison/evaluation/DCF_MVG&SVM_RBF_calibrated.png}
    \end{subfigure}
    \begin{subfigure}{0.5\textwidth}
        \includegraphics[scale=0.5]{../../images/comparison/evaluation/ROC_MVG&SVM_RBF_calibrated.png}
    \end{subfigure}
\end{figure}
...
\begin{figure}[H]
    \begin{subfigure}{0.5\textwidth}
        \includegraphics[scale=0.5]{../../images/comparison/evaluation/DCF_GMM&SVM_RBF.png}
    \end{subfigure}
    \begin{subfigure}{0.5\textwidth}
        \includegraphics[scale=0.5]{../../images/comparison/evaluation/ROC_GMM&SVM_RBF.png}
    \end{subfigure}
\end{figure}
...
\begin{figure}[H]
    \begin{subfigure}{0.5\textwidth}
        \includegraphics[scale=0.5]{../../images/comparison/evaluation/DCF_GMM&SVM_RBF_calibrated.png}
    \end{subfigure}
    \begin{subfigure}{0.5\textwidth}
        \includegraphics[scale=0.5]{../../images/comparison/evaluation/ROC_GMM&SVM_RBF_calibrated.png}
    \end{subfigure}
\end{figure}
We can see that the GMM is better then the SVM.

$\newline$
\textbf{Final Decision}
The best model is againt the Gaussian Mixture Model with 8 components, but the with the RAW we 
obtain midDCF = 0.219 and with PCA with m = 9 we obtain midDCF = 0.217. So the best of the best 
would be the GMM PCA with m = 9 instead of GMM RAW. Anyway, the difference is so small that we can 
