...
$\newline$
We can see that the Tied Full Covariance is the best in almost all components. Meanwhile the worst is the Full Covariance that
reach a midDCF = 1.0 with 128 components.
