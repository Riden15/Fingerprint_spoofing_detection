...
from Utility_functions.General_functions import kfold
...
def ll_GMM(Dtr, Ltr, Dte, llr, cov, comp):
    ...
    llr.extend(GMM_Full(Dtr, Dte, Ltr, optimal_alpha, 2 ** optimal_comp, optimal_cov).tolist())
    return llr
