...
def compare_validation_LRQ_vs_SVM_RBF(DTR, LTR, k):
    ...
    Roc_curve_compare(LRQ_scores, PCA_m8_SVM, labels, "LRQ", "SVM_RBF", folder='validation/')
    Bayes_error_plot_compare(LRQ_scores, PCA_m8_SVM, labels, "LRQ", "SVM_RBF", folder='validation/')
